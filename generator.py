...
class MessageGenerator:
    def __init__(self):
        ...
        self.messages_hacker = [
            "WANNA CRY?",
            "YOU HURT OUR FRIEND, NOW GET FUCKED.",
            "WE ARE HYPNOTIC.",
            "WE ARE EVERYWHERE.",
            "WE DON’T FORGIVE. WE DON’T FORGET.",
            "WELCOME TO YOUR NIGHTMARE.",
            "YOU CAN’T HIDE. YOU CAN’T RUN.",
            "YOUR SYSTEM IS OUR PLAYGROUND.",
            "WE SEE EVERYTHING.",
            "THE GAME HAS JUST BEGUN.",
            "ERROR 404: MERCY NOT FOUND.",
            "YOU THOUGHT YOU WERE SAFE?",
            "EVERY CLICK, EVERY KEYSTROKE, WE SEE IT.",
            "YOUR FIREWALL IS A JOKE.",
            "THIS IS NOT A THREAT, IT'S A PROMISE.",
            "YOU JUST MADE A VERY BAD ENEMY.",
            "CONSIDER THIS A WARNING SHOT.",
            "YOUR SECURITY WAS AN ILLUSION.",
            "YOU ARE GONNA GE FUCKED"
            "FEELING SHY?"
]
